        ...
        namespace time_utils {
            namespace {
                ...
                inline std::chrono::system_clock::time_point &start() {
                    static std::chrono::system_clock::time_point _ = now();
                    return _;
                };
            
                inline const std::chrono::system_clock::time_point &start_time() {
                    return start();
                }
                ...
                inline std::string get_current_date_string(const std::string &format) {
